...
set_property --dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { mcu[1] }]; #IO_L10N_T1_D15_14
set_property --dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { mcu[0] }]; #IO_L10P_T1_D14_14
set_property --dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { led_green }]; #IO_L9N_T1_DQS_D13_14
...
set_property --dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { dac_data }]; #IO_L4N_T0_D05_14
set_property --dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { dac_word }]; #IO_L4P_T0_D04_14
set_property --dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { dac_clk }]; #IO_L5N_T0_D07_14
set_property --dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { dac_bclk }]; #IO_L5P_T0_D06_14

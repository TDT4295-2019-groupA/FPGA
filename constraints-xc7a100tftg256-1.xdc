...
#
## I2S
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { io_i2s_bclk }]; #IO_L4N_T0_D05_14
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { io_i2s_mclk }]; #IO_L4P_T0_D04_14
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { io_i2s_lrck }]; #IO_L5N_T0_D07_14
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { io_i2s_data }]; #IO_L5P_T0_D06_14
...
# GPIO
set_property -dict { PACKAGE_PIN N9   IOSTANDARD LVCMOS33 } [get_ports { io_gpio }]; 

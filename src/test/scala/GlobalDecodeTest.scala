...
object DecoderTests {
  ...
  class GlobalStateDecoderTest(c: GlobalStateDecoder) extends PeekPokeTester(c) {
    ...
    Volume = 0-128 (64 for this) = 01000000
    Envelope = Form of envelope, ensure it matches. For this:
    11001100 10101010 00011100 11001100 10101010 00011100 11001100 10101010 00011100 11001100 10101010 00011100 11001100 10101010
    ...
    In total:
    11110000111000111100110010101010111100001110001111001100101010101111000011100011110011001010101011110000111000111100110010101010110011001010101000011100110011001010101000011100110011001010101000011100110011001010101000011100110011001010101001000000
     */

    poke(c.io.packetIn.toBits, BigInt("11110000111000111100110010101010111100001110001111001100101010101111000011100011110011001010101011110000111000111100110010101010110011001010101000011100110011001010101000011100110011001010101000011100110011001010101000011100110011001010101001000000", 2))
